...
export function VisualizerPane() {
  ...
  const [steppedPeakHoldTime, setSteppedPeakHoldTime] = useAtom(steppedPeakHoldTimeAtom);
  const [steppedPeakFallSpeed, setSteppedPeakFallSpeed] = useAtom(steppedPeakFallSpeedAtom);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <Select value={animationMode} onValueChange={(v) => setAnimationMode(v as AnimationMode)}>
