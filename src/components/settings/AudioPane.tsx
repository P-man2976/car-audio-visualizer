...
export function AudioPane() {
  ...
  const update = useCallback(
    <K extends keyof AudioMotionSettings>(key: K, value: AudioMotionSettings[K]) => {
      ...
      <div className="flex flex-col gap-3">
        ...
        {isMECSNBroken() ? (
          <p className="text-xs text-neutral-500">
            Safari では AM フィルタを利用できません。Chrome / Firefox をご利用ください。
          </p>
        ) : (
          <>
            <SettingRow
            ...
            {amFilterEnabled && (
              <>
                <div className="flex items-center justify-between pt-1">
                  <span className="text-[10px] text-neutral-500">AM フィルタ詳細設定</span>
                  <button
                    type="button"
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <Slider
            ...
            onValueChange={([v]) => v !== undefined && update("smoothingTimeConstant", v)}
          />
        </SettingRow>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <Slider
            ...
            onValueChange={([v]) => {
              if (v !== undefined && v < settings.maxDecibels) update("minDecibels", v);
            }}
          />
        </SettingRow>
        ...
        >
          <Slider
            ...
            onValueChange={([v]) => {
              if (v !== undefined && v > settings.minDecibels) update("maxDecibels", v);
            }}
          />
        </SettingRow>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <Select
            ...
            onValueChange={(v) =>
              update("weightingFilter", (v === "none" ? "" : v) as WeightingFilter)
            }
          >
            ...
            <SelectContent>
              {(Object.keys(WEIGHTING_FILTER_LABELS) as WeightingFilter[]).map((f) => (
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <Slider
            ...
            onValueChange={([v]) => v !== undefined && update("peakFallSpeed", v)}
          />
        </SettingRow>
      </div>
    </div>
