  ...
  return (
    <div ref={containerRef} className="flex w-full grow-0 flex-col gap-1 overflow-hidden">
      <div className="flex items-center gap-1.5 overflow-hidden">
        ...
        <h2
          ref={titleRef}
          className={cn("w-fit whitespace-nowrap text-base sm:text-lg md:text-xl", {
            "animate-scroll":
      ...
      <span
        ref={albumRef}
        className={cn("hidden w-fit whitespace-nowrap text-xs text-gray-400 sm:block sm:text-sm", {
          "animate-scroll":
      ...
      <span
        ref={artistRef}
        className={cn("w-fit whitespace-nowrap text-xs text-gray-400 sm:text-sm", {
          "animate-scroll":
            (artistRef.current?.clientWidth ?? 0) > (containerRef.current?.clientWidth ?? 0),
        })}
      >
        {artist}
      </span>
