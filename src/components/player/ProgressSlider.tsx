...
export function ProgressSlider() {
  ...
  useEffect(() => {
    setDisplayString(
      buildDisplayString(currentSrc, currentRadio, progress, currentSong, tuningFreq, channelNum),
    );
  }, [currentSrc, currentRadio, progress, currentSong, tuningFreq, channelNum, setDisplayString]);
