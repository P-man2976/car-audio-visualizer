...
describe("Separator", () => {
  test("デフォルトは horizontal", async () => {
    void render(<Separator data-testid="sep" />);
  ...
  test("orientation=vertical が反映される", async () => {
    void render(<Separator orientation="vertical" data-testid="sep-v" />);
  ...
  test("デフォルトは decorative（role=none）", async () => {
    void render(<Separator data-testid="sep-dec" />);
  ...
  test("decorative=false で role=separator になる", async () => {
    void render(<Separator decorative={false} />);
