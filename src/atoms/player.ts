...
const _persistedSrcAtom = atomWithStorage<Exclude<Source, "aux">>("cav-current-src-v2", "off");
...
export const songQueueAtom = atomWithIDB<Song[]>("cav-song-queue-v2", [], createSongArrayStorage());
 ...
 */
export const savedDirectoryHandlesAtom = atomWithIDB<FileSystemDirectoryHandle[]>(
  "cav-dir-handles-v2",
  [],
  createDirectoryHandleArrayStorage(),
);
