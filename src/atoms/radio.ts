...
export const currentRadioAtom = atomWithStorage<Radio | null>("cav-current-radio-v2", null);
...
/** チャンネルプリセット（エリアごとに保存） */
export const radioChannelsByAreaAtom = atomWithStorage<Record<string, AreaChannels>>(
